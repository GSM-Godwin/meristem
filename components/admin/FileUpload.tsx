    ...
    <div className="space-y-2">
      {value ? (
        <div>
          {kind === "video" ? (
            <video
              src={value}
              controls
              className="h-44 w-full max-w-sm rounded-lg border border-light2 bg-black object-contain"
            />
          ) : (
            <a
              href={value}
              ...
              className="flex items-center gap-3 rounded-lg border border-light2 bg-light1 px-4 py-3 max-w-sm hover:border-primary transition-colors"
            >
        ...
        <button
          ...
          onClick={() => inputRef.current?.click()}
          disabled={uploading}
          className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-light2 bg-light1 text-neutral hover:border-primary hover:text-primary transition-colors disabled:opacity-60 h-44 w-full max-w-sm"
        >
          {uploading ? (
