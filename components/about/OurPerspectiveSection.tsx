export default function OurPerspectiveSection() {
  return (
    <section className="bg-primarybg py-20 px-5 md:px-10 lg:px-20">
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-yellow mb-8">
          Our Perspective
        </p>
